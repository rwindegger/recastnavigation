...
void NavMeshTesterTool::handleMenu()
{
	...
	if (ImGui::RadioButton("Set Random End", m_sposSet))
	{
		if (m_sposSet)
		{
	...
	if (ImGui::RadioButton("Make Random Points Around", m_sposSet))
	{
		if (m_sposSet)
		{
			m_nrandPoints = 0;
	...
	if (ImGui::RadioButton("Swim", (m_filter.getIncludeFlags() & AREAFLAGS_SWIM) != 0))
	{
		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ AREAFLAGS_SWIM);
		recalc();
	}
	if (ImGui::RadioButton("Door", (m_filter.getIncludeFlags() & AREAFLAGS_DOOR) != 0))
	{
		m_filter.setIncludeFlags(m_filter.getIncludeFlags() ^ AREAFLAGS_DOOR);
		recalc();
	}
	if (ImGui::RadioButton("Jump", (m_filter.getIncludeFlags() & AREAFLAGS_JUMP) != 0))
	{
	...
	if (ImGui::RadioButton("Swim", (m_filter.getExcludeFlags() & AREAFLAGS_SWIM) != 0))
	{
		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ AREAFLAGS_SWIM);
		recalc();
	}
	if (ImGui::RadioButton("Door", (m_filter.getExcludeFlags() & AREAFLAGS_DOOR) != 0))
	{
		m_filter.setExcludeFlags(m_filter.getExcludeFlags() ^ AREAFLAGS_DOOR);
		recalc();
	}
	if (ImGui::RadioButton("Jump", (m_filter.getExcludeFlags() & AREAFLAGS_JUMP) != 0))
	{
